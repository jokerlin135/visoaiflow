...
class FemaleWidget extends StatefulWidget {
  ...
  static String routeName = 'female';
  static String routePath = '/female';
...
class _FemaleWidgetState extends State<FemaleWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FemaleModel());
  }
